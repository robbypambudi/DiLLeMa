...
#
# Base: official Ray 2.55.0 image with Python 3.12 + CUDA 12.8 (x86_64).
# Verified to exist as rayproject/ray:2.55.0-py312-cu128. The GPU is provided by
...
FROM rayproject/ray:2.55.0-py312-cu128
