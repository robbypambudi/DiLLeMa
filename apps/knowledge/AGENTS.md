...
- Run the relevant offline tests using the dashboard environment. The full command from root is `PYTHONPATH=apps apps/.venv/bin/python -m unittest discover -s apps/tests -v`.
