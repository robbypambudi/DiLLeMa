...
- Run the relevant offline tests using the dashboard environment. The full command from root is `uv run --directory apps python -m unittest discover -s tests -v`.
